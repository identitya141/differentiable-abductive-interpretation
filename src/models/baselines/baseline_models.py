...
BASELINE_REGISTRY: Dict[str, BaselineSpec] = {
    ...
    "random_structure": BaselineSpec("random_structure", "Random-operator control", RandomStructureT5, runner="dai_control", config_name="random_structure.yaml"),
    "shuffled_structure": BaselineSpec("shuffled_structure", "Shuffled-operator control", ShuffledStructureT5, runner="dai_control", config_name="shuffled_structure.yaml"),
