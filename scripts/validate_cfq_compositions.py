...
def validate_cfq_corpus(data_dir: Path, minimum_coverage: float = 0.1) -> Dict:
    report = {
        "dataset": "cfq",
        "mcd_splits": {},
        "total_examples": 0,
...
def main() -> None:
    ...
    parser.add_argument("--minimum-coverage", type=float, default=0.1)
    args = parser.parse_args()

    report = validate_cfq_corpus(args.data_dir, args.minimum_coverage)
